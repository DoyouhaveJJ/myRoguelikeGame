...
namespace myRougelikeGame.Items.Wearable.SignsForChest
{
    class signforchest_MarkSign:defaultItem
    {
         public signforchest_MarkSign()
        {
            setType(19);//19=胸章
            setName("某纪念章");
            setID(20);
        ...
        {
            base.updataQuality();
            if (getIsEquited()) { setName("某纪念章(已装备)"); }
            else { setName("某纪念章"); }
        }
